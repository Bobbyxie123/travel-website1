...
export const ProductCollection: React.FC<PropsType> = ({title,sideImage,products}) => { 
  return(
    <div className={styles.content}>
      ...
      <Row>
          <Col span={4}>
            {/* first divide them into 4 and 20  */}
            <img src={sideImage} className={styles["side-image"]} alt="" />
          </Col>
          <Col span={20}>
             {/* first divide them into 4 and 20  */}
            <Row>
              {/* then divide col 20 into 2 row  */}
              <Col span={12}>
                {/* then divide first row into col 12 and col 12 , this col is for big pic*/}
                <ProductImage
                  id={products[0].id}
                  size={"large"}
              ...
              <Col span={12}>
                {/* then divide first col into 12 col for the small pic  */}
                <Row>
                  <Col span={12}>
                    <ProductImage
                      id={products[1].id}
            ...
            <Row>
             {/* then divide col 20 into 2 row, this is second row */}
              <Col span={6}>
                <ProductImage
                  id={products[5].id}
                  size="small"
